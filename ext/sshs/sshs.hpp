...
static inline void sshsNodeCreate(sshsNode node, const char *key, int8_t defaultValue, int8_t minValue, int8_t maxValue,
...
static inline void sshsNodeCreate(sshsNode node, const char *key, float defaultValue, float minValue, float maxValue,
	enum sshs_node_attr_flags flags, const char *description) {
	sshsNodeCreateFloat(node, key, defaultValue, minValue, maxValue, flags, description);
}

static inline void sshsNodeCreate(sshsNode node, const char *key, double defaultValue, double minValue, double maxValue,
	enum sshs_node_attr_flags flags, const char *description) {
	sshsNodeCreateDouble(node, key, defaultValue, minValue, maxValue, flags, description);
}

static inline void sshsNodeCreate(sshsNode node, const char *key, const char *defaultValue, size_t minLength,
...
static inline void sshsNodeCreate(sshsNode node, const char *key, const std::string &defaultValue, size_t minLength,
