...
static bool setCamContent(caerInputDynapseState state, int16_t chipId, bool ei, bool fs, int16_t address, int8_t source_core,
...
bool caerInputDYNAPSEInit(caerModuleData moduleData) {
	...
	sshsNodeCreateShort(sourceInfoNode, "logicVersion", dynapse_info.logicVersion, dynapse_info.logicVersion,
		dynapse_info.logicVersion, SSHS_FLAGS_READ_ONLY_FORCE_DEFAULT_VALUE, "Device FPGA logic version.");
