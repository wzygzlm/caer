...
static const struct caer_module_info EDVSInfo = { .version = 1, .name = "eDVS4337", .type = CAER_MODULE_INPUT,
	.memSize = 0, .functions = &EDVSFunctions, .inputStreams = NULL, .inputStreamsSize = 0,
	.outputStreams = EDVSOutputs, .outputStreamsSize = CAER_EVENT_STREAM_OUT_SIZE(EDVSOutputs), };
