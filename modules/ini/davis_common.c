...
bool caerInputDAVISInit(caerModuleData moduleData, uint16_t deviceType) {
	...
	sshsNodeCreateLong(sourceInfoNode, "highestTimestamp", -1, -1, INT64_MAX, SSHS_FLAGS_READ_ONLY_FORCE_DEFAULT_VALUE,
	...
	sshsNodeCreateShort(sourceInfoNode, "logicVersion", devInfo.logicVersion, devInfo.logicVersion,
		devInfo.logicVersion, SSHS_FLAGS_READ_ONLY_FORCE_DEFAULT_VALUE, "Device FPGA logic version.");
	sshsNodeCreateBool(sourceInfoNode, "deviceIsMaster", devInfo.deviceIsMaster,
		SSHS_FLAGS_READ_ONLY_FORCE_DEFAULT_VALUE, "Timestamp synchronization support: device master status.");
	sshsNodeCreateShort(sourceInfoNode, "chipID", devInfo.chipID, devInfo.chipID, devInfo.chipID,
		SSHS_FLAGS_READ_ONLY_FORCE_DEFAULT_VALUE, "Device chip identification number.");

	sshsNodeCreateShort(sourceInfoNode, "polaritySizeX", devInfo.dvsSizeX, devInfo.dvsSizeX, devInfo.dvsSizeX,
		SSHS_FLAGS_READ_ONLY_FORCE_DEFAULT_VALUE, "Polarity events width.");
	sshsNodeCreateShort(sourceInfoNode, "polaritySizeY", devInfo.dvsSizeY, devInfo.dvsSizeY, devInfo.dvsSizeY,
		SSHS_FLAGS_READ_ONLY_FORCE_DEFAULT_VALUE, "Polarity events height.");
	sshsNodeCreateBool(sourceInfoNode, "dvsHasPixelFilter", devInfo.dvsHasPixelFilter,
		SSHS_FLAGS_READ_ONLY_FORCE_DEFAULT_VALUE, "Device supports FPGA DVS Pixel-Filtering.");
	sshsNodeCreateBool(sourceInfoNode, "dvsHasBackgroundActivityFilter", devInfo.dvsHasBackgroundActivityFilter,
		SSHS_FLAGS_READ_ONLY_FORCE_DEFAULT_VALUE, "Device supports FPGA DVS Background-Activity-Filtering.");
	sshsNodeCreateBool(sourceInfoNode, "dvsHasTestEventGenerator", devInfo.dvsHasTestEventGenerator,
		SSHS_FLAGS_READ_ONLY_FORCE_DEFAULT_VALUE, "Device supports FPGA DVS Test-Event-Generator.");

	sshsNodeCreateShort(sourceInfoNode, "frameSizeX", devInfo.apsSizeX, devInfo.apsSizeX, devInfo.apsSizeX,
		SSHS_FLAGS_READ_ONLY_FORCE_DEFAULT_VALUE, "Frame events width.");
	sshsNodeCreateShort(sourceInfoNode, "frameSizeY", devInfo.apsSizeY, devInfo.apsSizeY, devInfo.apsSizeY,
		SSHS_FLAGS_READ_ONLY_FORCE_DEFAULT_VALUE, "Frame events height.");
	sshsNodeCreateByte(sourceInfoNode, "apsColorFilter", devInfo.apsColorFilter, devInfo.apsColorFilter,
		devInfo.apsColorFilter, SSHS_FLAGS_READ_ONLY_FORCE_DEFAULT_VALUE, "APS sensor color-filter pattern.");
	sshsNodeCreateBool(sourceInfoNode, "apsHasGlobalShutter", devInfo.apsHasGlobalShutter,
		SSHS_FLAGS_READ_ONLY_FORCE_DEFAULT_VALUE, "APS sensor supports global-shutter mode.");
	sshsNodeCreateBool(sourceInfoNode, "apsHasQuadROI", devInfo.apsHasQuadROI, SSHS_FLAGS_READ_ONLY_FORCE_DEFAULT_VALUE,
	...
	sshsNodeCreateBool(sourceInfoNode, "apsHasExternalADC", devInfo.apsHasExternalADC,
		SSHS_FLAGS_READ_ONLY_FORCE_DEFAULT_VALUE, "Readout APS sensor using an external ADC chip.");
	sshsNodeCreateBool(sourceInfoNode, "apsHasInternalADC", devInfo.apsHasInternalADC,
		SSHS_FLAGS_READ_ONLY_FORCE_DEFAULT_VALUE, "Readout APS sensor using chip-internal ADC.");

	sshsNodeCreateBool(sourceInfoNode, "extInputHasGenerator", devInfo.extInputHasGenerator,
		SSHS_FLAGS_READ_ONLY_FORCE_DEFAULT_VALUE, "Device supports generating pulses on output signal jack.");
	sshsNodeCreateBool(sourceInfoNode, "extInputHasExtraDetectors", devInfo.extInputHasExtraDetectors,
		SSHS_FLAGS_READ_ONLY_FORCE_DEFAULT_VALUE, "Device supports extra signal detectors on additional pins.");
	...
	sshsNodeCreateString(sourceInfoNode, "sourceString", sourceString, sourceStringLength, sourceStringLength,
		SSHS_FLAGS_READ_ONLY_FORCE_DEFAULT_VALUE, "Device source information.");
...
bool enabled, const char *sex, const char *type) {
	...
	sshsNodeCreateString(biasConfigNode, "sexListOptions", "N,P", 0, 10, SSHS_FLAGS_READ_ONLY_FORCE_DEFAULT_VALUE,
	...
	sshsNodeCreateString(biasConfigNode, "typeListOptions", "Normal,Cascode", 0, 30,
		SSHS_FLAGS_READ_ONLY_FORCE_DEFAULT_VALUE, "Bias type possible values.");
	...
	sshsNodeCreateString(biasConfigNode, "currentLevelListOptions", "Normal,Low", 0, 20,
		SSHS_FLAGS_READ_ONLY_FORCE_DEFAULT_VALUE, "Bias current level possible values.");
}
...
static void createShiftedSourceBiasSetting(sshsNode biasNode, const char *biasName, uint8_t refValue, uint8_t regValue,
	...
	sshsNodeCreateString(biasConfigNode, "operatingModeListOptions", "ShiftedSource,HiZ,TiedToRail", 0, 40,
		SSHS_FLAGS_READ_ONLY_FORCE_DEFAULT_VALUE, "Shifted-source operating mode possible values.");
