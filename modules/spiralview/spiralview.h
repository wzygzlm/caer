...
void caerSpiralView(uint16_t moduleID, caerPolarityEventPacket polarity, int classify_img_size, int *packet_hist, int *packet_hist_view, caerFrameEventPacket *imagegeneratorFrame);
