...
class Axidma {
    protected:
        ...
        const unsigned int DESTINATION_ADDR_OFFSET_0; //!< Memory offset that points to reserved memory space for S2MM data
        const unsigned int DESTINATION_ADDR_OFFSET_1; //!< Memory offset that points to reserved memory space for S2MM data
        const unsigned int SOURCE_ADDR_OFFSET_0;      //!< Memory offset that points to reserved memory space for MM2S data
        const unsigned int SOURCE_ADDR_OFFSET_1;      //!< Memory offset that points to reserved memory space for MM2S data
